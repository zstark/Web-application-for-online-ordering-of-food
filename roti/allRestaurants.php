...
if(isset($_SESSION['admin']) && isset($_SESSION['admin'])){
	...
	<table id="example" class="display stripe" cellspacing="0" width="100%" style="border:1px solid #000;font-size:12px;">
        ...
        <tbody>
            ...
            <?php
            $arr = getRecords("SELECT * FROM restaurant");


            foreach ($arr as $val) {
            	?>
            	<tr id = "oi-<?php echo $val['restaurant.id']; ?>">
            		<td><?php echo $val['restaurant.id']; ?></td>
            		<td><?php echo $val['restaurant.name']; ?></td>
	                <td><?php echo $val['restaurant.phone']; ?></td>
	                <td><?php echo $val['restaurant.address']; ?></td>
	                <td><?php echo $val['restaurant.doj']; ?></td>
